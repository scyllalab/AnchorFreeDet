...
_all__ = ['resnest50', 'resnest101', 'resnest200', 'resnest269', "SplAtConv2d"]
...
class SplAtConv2d(Module):
    ...
    def forward(self, x):
        ...
        if self.radix > 1:
            ...
            gap = x
        #针对于没有给split求一个均值 gap 8 x 64x 128 x 128
...
if __name__ == "__main__":
    model = SplAtConv2d(64, 64, 3, norm_layer=nn.BatchNorm2d, bias= False)
    # model = resnest18()
    print(model)
    data = torch.randn(8, 64, 256, 256)
    out = model(data)
    print(out.shape)